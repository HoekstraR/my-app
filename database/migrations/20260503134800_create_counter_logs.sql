-- counter_logs: publieke teller log tabel
-- Elke klik (increment / decrement / reset) wordt hier opgeslagen
-- inclusief de tellerwaarde na de actie.
...
CREATE POLICY "anon can insert"
  ON counter_logs FOR INSERT TO anon
  WITH CHECK (true);

CREATE POLICY "anon can select"
  ON counter_logs FOR SELECT TO anon
  USING (true);
